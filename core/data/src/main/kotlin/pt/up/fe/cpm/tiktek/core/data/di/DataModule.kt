...
import pt.up.fe.cpm.tiktek.core.data.remote.RemoteCafeteriaRepository
...
abstract class DataModule {
    @Binds
    abstract fun bindCafeteriaRepository(repo: RemoteCafeteriaRepository): CafeteriaRepository
